...
- [x] **T-030-003** Persistencia, migraciones y unidad de trabajo. `[IMP-010..013]` Esquema
  reversible, UoW, auditoria y fusion segura de cambios disjuntos implementados.
