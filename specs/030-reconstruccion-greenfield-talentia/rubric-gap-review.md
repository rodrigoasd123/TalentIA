...
| CV y almacenamiento privado | Parcial | Firma/tamano, hash, ruta privada, escritura atomica y traversal bloqueado | Conectar extraccion PDF/DOCX/OCR al worker y politica `BIZ-007` |
| Cinco agentes definidos | Parcial | AG-01/04/05 deterministas y AG-02/03 hibridos tienen modulos y pruebas unitarias | El worker no ejecuta todavia los nodos reales AG-02/03 |
...
| Evaluacion con evidencia | Parcial | Evaluaciones/requisitos persistibles, referencias modeladas, contexto referencial validado | Integrar lectura original, sanitizacion y evaluador en el procesador |
...
| Privacidad y prompt injection | Parcial | Sanitizador fail-closed, PII retirada, instrucciones incrustadas bloqueadas | Prueba E2E que confirme que el worker no invoca proveedor tras fallo |
