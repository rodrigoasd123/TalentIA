# CURRICULUM VITAE - RODRIGO MARTIN HUAMAN DELGADO

**DNI / Documento:** 44852179  
**Correo Electrónico:** [rodrigo.huaman@gmail.com](mailto:rodrigo.huaman@gmail.com)  
**Teléfono / Celular:** +51 986532147  
**Ubicación:** Pueblo Libre, Lima  
**Canal de Atracción:** LinkedIn  
**Convocatoria de Postulación:** `QA-AUTO-02` - Ingeniero QA Automation (Web / API)  
**Expectativa Salarial:** S/ 6,700.00  
**Estado en Proceso:** `APTO`  

---

## 1. Resumen Ejecutivo
Profesional en Ingeniería de Sistemas con sólida trayectoria en Playwright, TypeScript, Pytest, Jenkins. Apasionado por la excelencia técnica, metodologías ágiles y soluciones que agregan valor directo al negocio.

## 2. Competencias Técnicas
- **Especialidad:** Playwright, TypeScript, Pytest, Jenkins
...
### **Especialista en Automatización e Infraestructura** | *Telefónica Tech Perú*
...
- **Bachiller / Titulado en Ingeniería de Sistemas y Computación**  
  *Universidad Peruana de Ciencias Aplicadas (UPC)* (2013 - 2018)
