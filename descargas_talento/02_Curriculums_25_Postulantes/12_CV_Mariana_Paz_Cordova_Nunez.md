# CURRICULUM VITAE - MARIANA PAZ CORDOVA NUNEZ

**DNI / Documento:** 48521479  
**Correo Electrónico:** [mariana.cordova@hotmail.com](mailto:mariana.cordova@hotmail.com)  
**Teléfono / Celular:** +51 981452369  
**Ubicación:** Barranco, Lima  
**Canal de Atracción:** LinkedIn  
**Convocatoria de Postulación:** `QA-AUTO-02` - Ingeniero QA Automation (Web / API)  
**Expectativa Salarial:** S/ 7,000.00  
**Estado en Proceso:** `RESPALDO`  

---

## 1. Resumen Ejecutivo
Profesional en Ingeniería de Sistemas con sólida trayectoria en Playwright, Postman, Cucumber BDD, ISTQB. Apasionado por la excelencia técnica, metodologías ágiles y soluciones que agregan valor directo al negocio.

## 2. Competencias Técnicas
- **Especialidad:** Playwright, Postman, Cucumber BDD, ISTQB
