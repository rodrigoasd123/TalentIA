# CURRICULUM VITAE - MATEO ALEJANDRO RIOS FERNANDEZ

**DNI / Documento:** 43981245  
**Correo Electrónico:** [mateo.rios@gmail.com](mailto:mateo.rios@gmail.com)  
**Teléfono / Celular:** +51 975841236  
**Ubicación:** Surco, Lima  
**Canal de Atracción:** Referido  
**Convocatoria de Postulación:** `DEV-BACK-01` - Desarrollador Backend Senior (Python / Cloud)  
**Expectativa Salarial:** S/ 9,000.00  
**Estado en Proceso:** `APTO`  

---

## 1. Resumen Ejecutivo
Profesional en Ingeniería de Sistemas con sólida trayectoria en Python, FastAPI, Microservicios, Kubernetes. Apasionado por la excelencia técnica, metodologías ágiles y soluciones que agregan valor directo al negocio.

## 2. Competencias Técnicas
- **Especialidad:** Python, FastAPI, Microservicios, Kubernetes
...
### **Consultor Técnico** | *Software Factory Latam*
*2019 - 2022 | Perú*
