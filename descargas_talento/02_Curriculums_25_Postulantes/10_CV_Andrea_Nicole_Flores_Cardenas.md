# CURRICULUM VITAE - ANDREA NICOLE FLORES CARDENAS

**DNI / Documento:** 47852369  
**Correo Electrónico:** [andrea.flores@outlook.com](mailto:andrea.flores@outlook.com)  
**Teléfono / Celular:** +51 993214587  
**Ubicación:** Magdalena, Lima  
**Canal de Atracción:** Adecco  
**Convocatoria de Postulación:** `QA-AUTO-02` - Ingeniero QA Automation (Web / API)  
**Expectativa Salarial:** S/ 6,500.00  
**Estado en Proceso:** `EN_PROCESO`  

---

## 1. Resumen Ejecutivo
Profesional en Ingeniería de Sistemas con sólida trayectoria en Cypress, JavaScript, Postman, JMeter. Apasionado por la excelencia técnica, metodologías ágiles y soluciones que agregan valor directo al negocio.

## 2. Competencias Técnicas
- **Especialidad:** Cypress, JavaScript, Postman, JMeter
