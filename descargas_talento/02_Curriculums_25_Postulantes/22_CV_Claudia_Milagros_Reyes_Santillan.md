# CURRICULUM VITAE - CLAUDIA MILAGROS REYES SANTILLAN

**DNI / Documento:** 46125478  
**Correo Electrónico:** [claudia.reyes@gmail.com](mailto:claudia.reyes@gmail.com)  
**Teléfono / Celular:** +51 951478523  
**Ubicación:** Jesus Maria, Lima  
**Canal de Atracción:** Adecco  
**Convocatoria de Postulación:** `DATA-ENG-03` - Ingeniero de Datos (ETL / Big Data / Analytics)  
**Expectativa Salarial:** S/ 8,800.00  
**Estado en Proceso:** `APTO`  

---

## 1. Resumen Ejecutivo
Profesional en Ingeniería de Sistemas con sólida trayectoria en Data Engineering, Snowflake, SQL, Python, dbt. Apasionado por la excelencia técnica, metodologías ágiles y soluciones que agregan valor directo al negocio.

## 2. Competencias Técnicas
- **Especialidad:** Data Engineering, Snowflake, SQL, Python, dbt
...
### **Ingeniero de Datos y Procesos** | *Retail Corp Solutions*
...
### **Tech Lead / Desarrollador Especialista** | *Fintech Andina S.A.C.*
*2019 - 2022 | Perú*
...
- **Bachiller / Titulado en Ingeniería de Sistemas y Computación**  
  *Pontificia Universidad Católica del Perú (PUCP)* (2013 - 2018)
