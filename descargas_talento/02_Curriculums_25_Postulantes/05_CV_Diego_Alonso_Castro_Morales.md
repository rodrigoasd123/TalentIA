# CURRICULUM VITAE - DIEGO ALONSO CASTRO MORALES

**DNI / Documento:** 42157896  
**Correo Electrónico:** [diego.castro@gmail.com](mailto:diego.castro@gmail.com)  
**Teléfono / Celular:** +51 964785123  
**Ubicación:** Arequipa  
**Canal de Atracción:** Computrabajo  
**Convocatoria de Postulación:** `DEV-BACK-01` - Desarrollador Backend Senior (Python / Cloud)  
**Expectativa Salarial:** S/ 8,500.00  
**Estado en Proceso:** `EN_PROCESO`  

---

## 1. Resumen Ejecutivo
Profesional en Ingeniería de Sistemas con sólida trayectoria en Python, Django, AWS Lambda, DynamoDB. Apasionado por la excelencia técnica, metodologías ágiles y soluciones que agregan valor directo al negocio.

## 2. Competencias Técnicas
- **Especialidad:** Python, Django, AWS Lambda, DynamoDB
