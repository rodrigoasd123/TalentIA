# CURRICULUM VITAE - LORENA MARCELA TELLO HURTADO

**DNI / Documento:** 49125478  
**Correo Electrónico:** [lorena.tello@gmail.com](mailto:lorena.tello@gmail.com)  
**Teléfono / Celular:** +51 972584163  
**Ubicación:** San Borja, Lima  
**Canal de Atracción:** Portal TCS  
**Convocatoria de Postulación:** `DATA-ENG-03` - Ingeniero de Datos (ETL / Big Data / Analytics)  
**Expectativa Salarial:** S/ 8,900.00  
**Estado en Proceso:** `EN_PROCESO`  

---

## 1. Resumen Ejecutivo
Profesional en Ingeniería de Sistemas con sólida trayectoria en Python, Airflow, BigQuery, Docker. Apasionado por la excelencia técnica, metodologías ágiles y soluciones que agregan valor directo al negocio.

## 2. Competencias Técnicas
- **Especialidad:** Python, Airflow, BigQuery, Docker
